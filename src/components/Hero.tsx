...
const Hero = () => {
  return (
    <section className="w-full h-screen flex justify-center px-4 bg-[#ecf1f7] overflow-visible">
      <div className="w-full max-w-[1400px] flex gap-8 items-center overflow-visible">
        {/* Left Content */}
        <div className="flex-1 z-10 relative">
          <h1 className="text-8xl font-[Formula] mb-4 leading-tight">Welcome to ValidNet</h1>
          <div className="flex gap-2 mb-8">
            <span className="text-4xl font-[Formula] text-gray-900">Build Trust.</span>
            <span className="text-4xl font-[Formula] text-blue-600">Validate Intelligence.</span>
          </div>
          <p className="text-lg font-[Neue] text-gray-700 max-w-[600px] leading-relaxed mb-8">
